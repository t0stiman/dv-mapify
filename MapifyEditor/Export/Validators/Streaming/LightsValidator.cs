        ...
        protected override IEnumerator<Result> Validate(Scenes scenes)
        {
            ...
            foreach (Light light in lights)
                if (light.type == LightType.Directional)
                    yield return Result.Error($"You shouldn't have any Directional Lights in the {scenes.streamingScene.name} scene! It/they should go in the {scenes.gameContentScene.name}", light.gameObject);
        }
    }
}
#endif
